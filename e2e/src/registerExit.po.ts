...
export class ExitPage {
    ...
    getBtnRegisterButton(placa: string): ElementFinder {
        return $('#btnExit' + placa);
    }
    ...
    async clickBtnRegisterButton(placa: string): Promise<void> {
        await this.getBtnRegisterButton(placa).click();
    }
